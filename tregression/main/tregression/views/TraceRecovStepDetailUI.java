...
import microbat.tracerecov.CandidateVarRetriever;
		...
		public void mouseDown(MouseEvent e) {
			...
			if (objList.length != 0) {
				...
				if(obj instanceof VarValue) {
					...
					List<String> candidateVariables = CandidateVarRetriever.getCandidateVariables(currentNode.getInvokingMethod());
